...
export const metadata: Metadata = {
  title: "Sign In - E-ROOM",
  description: "Sign in to your student room account",
};
    ...
    return (
      <>
        ...
        <div className="flex min-h-screen flex-1">
                  ...
                  <form action="#" method="POST" className="space-y-6">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="adress@exemple.com"
                      />
                    </div>
          ...
          <Image className='absolute inset-0 h-full w-full object-cover' src={SingImg} alt='logo'/>
